 ...
 * a number >= the input.  In YayNode_AddChild, it's used like so, when
 ...
 * YayNode_AddChild passed 1 for the size, and 9% passed 4.  So this usually
...
int
YayNode_AddChild(node *n1, int type, char *str, int lineno, int col_offset)
{
