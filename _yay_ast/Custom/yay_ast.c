...
// Copied from Python/bltinmodule.c
static const char *
...
// Adapted from PyParser_ASTFromStringObject in Python/pythonrun.c
static mod_ty
...
static PyObject *
yay_ast_parse_impl(PyObject *module, PyObject *source, PyObject *filename,
                     const char *mode)
{
...
PyObject *
yay_ast_parse(PyObject *module, PyObject *args)
{
    ...
    if (PyArg_ParseTuple(args, "OO&s:parse", &source, PyUnicode_FSDecoder, &filename, &mode)) {
        return_value = yay_ast_parse_impl(module, source, filename, mode);
    }
